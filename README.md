...
<details>
<summary><strong>v3.0-25.07.18</strong> (2025年7月18日) - 🔄 RSS订阅开关功能  </summary>

- ✨ **RSS订阅开关**：添加RSS订阅启用/禁用开关功能
- 🔧 **菜单优化**：在编辑菜单中添加"🔄 订阅开关"选项
- 🎯 **用户体验**：支持通过序号快速切换订阅状态
- 📊 **状态显示**：订阅列表显示🟢启用/🔴禁用状态图标
- ⚙️ **配置管理**：自动保存启用状态到配置文件


</details>

<details>
<summary><strong>v3.0-25.05.24</strong> (2025年5月24日) - 🌐 多平台推送</summary>

- 🌐 **多平台推送**：完整集成message-pusher多平台推送功能
- 📡 **多Webhook支持**：支持最多10个webhook并发推送
- 🔄 **零侵入设计**：完全不影响现有Telegram功能
- 📝 **链接预览优化**：添加优化的消息格式
- ⏱️ **独立配置**：支持独立的超时和重试配置
- 🔧 **环境变量支持**：完善环境变量和YAML配置支持
- 📖 **详细文档**：新增配置文档和四种推送方案
- 🔄 **热重载**：支持配置热重载和向后兼容性
- 🐳 **Docker部署**：添加完整的Docker部署示例和故障排除指南

</details>

<details>
<summary><strong>v3.0-25.03.04</strong> (2025年3月4日) - 🔑 关键词设置优化</summary>
...
<details>
<summary><strong>v3.0-25.02.18</strong> (2025年2月18日) - 📚 文档结构优化</summary>

- 📝 **文档改进**：更新README.md文件结构
- 🏷️ **内容组织**：添加"简介"章节标题
- ✨ **格式优化**：调整文档开头格式，提高可读性
...
<details>
<summary><strong>v3.0-25.02.14</strong> (2025年2月14日) - 🐛 Markdown解析修复</summary>

- 🔧 **Bug修复**：修复Markdown解析中的特殊字符问题
- ⚡ **功能改进**：在escapeURL函数中添加对"-"字符的转义
- 💬 **消息优化**：在sendMessage函数中添加文本Markdown转义处理
- 📖 **帮助完善**：更新handleStart函数中的帮助文本格式

</details>

<details>
<summary><strong>v3.0-25.01.09</strong> (2025年1月9日) - 🔢 版本号统一</summary>

- 📦 **版本管理**：统一项目版本号
- 🔄 **版本更新**：从3.0-24.12.18更新到3.0-25.01.09
- ✅ **一致性保证**：确保项目版本一致性

</details>

<details>
<summary><strong>v3.0-24.12.18</strong> (2024年12月18日) - ⚙️ 发布流程</summary>

- 🚀 **CI/CD**：更新release.yml发布配置

</details>

<details>
<summary><strong>v2.3-24.12.18</strong> (2024年12月18日) - 🎯 初始发布</summary>

- 🚀 **项目初始化**：创建release.yml自动发布流程
- 📦 **基础功能**：RSS到Telegram机器人核心功能
